...
public class SignFilter implements GlobalFilter {
     ...
     * 10秒
     */
    private static final int FIVE_MILLISECONDS = 5000000;
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (HttpMethod.POST.equals(method)) {
            ...
            return verifySign(encryptMap) ? chain.filter(exchange) : GatewayUtils.failMono(exchange, CommCode.UNAUTHORIZED);
        }
        // GET、DELETE请求参数验签
